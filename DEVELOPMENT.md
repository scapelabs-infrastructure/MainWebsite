...
```bash
git remote add encore encore://scapelabs-platform-k7i2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/scapelabs-platform-k7i2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/scapelabs-platform-k7i2/settings/integrations/github)
